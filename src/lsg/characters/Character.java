...
public abstract class Character {
    ...
    public String toString() {
        ...
        return (String.format(Locale.US,"%-20s %-20s %-4s:%-10s %-7s:%-10s PROTECTION:%-10s BUFF:%-10s", "[ " + getClass().getSimpleName() + " ]", getName(), LIFE_STAT_STRING.toUpperCase(),String.format("%5d", this.getLife()), STAM_STAT_STRING.toUpperCase() ,String.format("%5d", this.getStamina()), String.format(Locale.US,"%6.2f", this.computeProtection()), String.format(Locale.US, "%6.2f", this.computeBuff())) + "(" + alive + ")");
    }
